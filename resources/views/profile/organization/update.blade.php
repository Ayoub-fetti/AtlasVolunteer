<x-app>
    ...
    @endif
    <div class="mt-10">
        <h2 class="text-xl font-bold mb-5">Modifier une Opportunité</h2>
        ...
        <form action="{{ route('opportunity.update', $opportunity->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description"
                    class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('description',$opportunity->description) }}</textarea>
                @error('description')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
