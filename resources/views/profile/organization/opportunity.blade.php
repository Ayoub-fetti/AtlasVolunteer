    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-gray-600">Créez une nouvelle opportunité pour attirer des bénévoles</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <div class="p-6 sm:p-8">
                    ...
                    <form action="{{ route('opportunity.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea id="description" name="description" rows="4"
                                    class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition">{{ old('description') }}</textarea>
                                @error('description')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <div id="cover-preview-container" class="mb-4 {{ optional($opportunity)->cover ? '' : 'hidden' }}">
                                    @if(optional($opportunity)->cover)
                                        <img id="cover-preview" src="{{ asset('storage/' . $opportunity->cover) }}" 
                                    ...
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="flex text-sm text-gray-600">
                                            <label for="cover" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none">
                                                ...
                                                <input id="cover" name="cover" type="file" class="sr-only" accept="image/*" onchange="previewCover(this)">
                                            </label>
