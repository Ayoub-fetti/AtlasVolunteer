...
<body class="bg-gradient-to-br from-blue-50 to-green-100 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-lg bg-white rounded-xl shadow-xl overflow-hidden my-8">
        ...
        <div class="p-8">
            ...
            <h1 class="text-2xl font-bold text-center text-gray-800 mb-2">Join as Volunteer</h1>
            <p class="text-center text-gray-500 mb-6">Create your volunteer account and start making a difference</p>
            
            <form action="{{ route('register.volunteer') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="name" name="name"
                            class="pl-10 block w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:ring-2 focus:ring-green-500 focus:border-green-500"
