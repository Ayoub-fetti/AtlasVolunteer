    ...
    <div class="w-full max-w-lg bg-white rounded-xl shadow-xl overflow-hidden my-8">
        ...
        <div class="p-8">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email"
                            class="pl-10 block w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:ring-2 focus:ring-green-500 focus:border-green-500"
                            placeholder="volunteer@example.com" value="{{ old('email') }}" required>
                        @error('email')
                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <p class="text-xs text-gray-500 mt-1">You will need to verify this email address</p>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="phone" name="phone"
                            class="pl-10 block w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:ring-2 focus:ring-green-500 focus:border-green-500"
                            placeholder="+212 123456789" value="{{ old('phone') }}">
                        @error('phone')
                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="mt-4 text-xs text-center text-gray-500">
                By signing up, you agree to receive verification emails for account activation.
            </div>
        </div>
    </div>
</div>
