        ...
        @endif
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Donateur</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($donations as $donation)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-500">{{ $donation->user->name }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <form action="{{ route('admin.donations.delete', $donation->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette donation? Cette action est irréversible.');" class="inline">
                                                @csrf
                                                @method('DELETE')
            ...
            @else
                <div class="py-12 px-6 text-center">
                    ...
                    <p class="mt-1 text-gray-500">Aucune donation n'a été ajoutée pour l'instant.</p>
                </div>
            @endif
        </div>
    </div>
