            ...
            <div class="p-6">
                ...
                @if($opportunity->status === 'open')
                    <div class="mt-8 p-6 bg-gray-50 rounded-lg" id="apply">
                        <h2 class="text-xl font-semibold text-gray-900 mb-4">Apply for this Opportunity</h2>
                        
                        @auth
                            <form action="{{ route('opportunity.apply', $opportunity->id) }}" method="POST">
                                @csrf
                                <div class="mb-4">
                                    <label for="motivation" class="block text-sm font-medium text-gray-700 mb-2">Your Motivation</label>
                                    <textarea 
                                        id="motivation"
                                        name="motivation" 
                                        rows="4"
                                        placeholder="Tell us about your self and why you want to volunteer for this opportunity..." 
                                        required 
                        ...
                        @else
                            <div class="bg-white p-4 rounded-md shadow-sm border border-gray-200">
                                <p class="text-gray-700">Please <a href="{{ route('login.form') }}" class="text-indigo-600 hover:text-indigo-900 font-medium">login</a> to apply for this opportunity.</p>
                            </div>
                        @endauth
                    </div>
                @endif
