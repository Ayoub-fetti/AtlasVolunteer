            ...
            <div class="p-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-gray-500">{{ $opportunity->organization->organization_name ?? 'no name'}}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-gray-500">{{ $opportunity->start_date }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-gray-500">{{ $opportunity->end_date }}</p>
                            </div>
                        </div>
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-4">
                    ...
                    @if($opportunity->status === 'open')
                        <a href="#apply" class="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
